...
agrometeor <- function(toc = TRUE, code_folding = "hide", number_sections=TRUE) {

  # get the locations of resource files located within the package
  css <- system.file("rmarkdown", "templates", "agrometeor" ,"resources", "style.css", package = "epuRate")
  footer <- system.file("rmarkdown", "templates", "agrometeor" ,"resources", "footer.html", package = "epuRate")
  header <- system.file("rmarkdown", "templates", "agrometeor" ,"resources", "header.html", package = "epuRate")
  template <- system.file("rmarkdown", "templates", "agrometeor" ,"resources", "template_agrometeor.html", package = "epuRate")
